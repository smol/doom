...
var DoomThingTable = {
  ...
  13: { label: "red keycard", sprite: "RKEY", sequence: "ab" },
  6: { label: "yellow keycard", sprite: "YKEY", sequence: "ab" },
  5: { label: "blue keycard", sprite: "BKEY", sequence: "ab" },
  38: { label: "red skull key", sprite: "RSKU", sequence: "ab" },
  39: { label: "yellow skull key", sprite: "YSKU", sequence: "ab" },
  40: { label: "blue skull key", sprite: "BSKU", sequence: "ab" },
  ...
  30: { label: "green pillar", sprite: "COL1", sequence: "a" },
  31: { label: "short green pillar", sprite: "COL2", sequence: "a" },
  32: { label: "red pillar", sprite: "COL3", sequence: "a" },
  33: { label: "short red pillar", sprite: "COL4", sequence: "a" },
  34: { label: "candle", sprite: "CAND", sequence: "a" },
  35: { label: "candelabra", sprite: "CBRA", sequence: "a" },
  36: { label: "green pillar with heart", sprite: "COL5", sequence: "ab" },
  37: { label: "red pillar with skull", sprite: "COL6", sequence: "a" },
  41: { label: "eye", sprite: "CEYE", sequence: "abcd" },
  42: { label: "skull rock", sprite: "FSKU", sequence: "abc" },
  43: { label: "gray tree", sprite: "TRE1", sequence: "a" },
  44: { label: "blue torch", sprite: "TBLU", sequence: "abcd" },
  45: { label: "green torch", sprite: "TGRE", sequence: "abcd" },
  46: { label: "red torch", sprite: "TRED", sequence: "abcd" },
  47: { label: "scrub", sprite: "SMIT", sequence: "a" },
  48: { label: "tech column", sprite: "ELEC", sequence: "a" },
  54: { label: "brown tree", sprite: "TRE2", sequence: "a" },
  55: { label: "short blue torch", sprite: "SMBT", sequence: "abcd" },
  56: { label: "short green torch", sprite: "SMGT", sequence: "abcd" },
  57: { label: "short red torch", sprite: "SMRT", sequence: "abcd" },
  2028: { label: "floor lamp", sprite: "COLU", sequence: "a" },
  2035: { label: "barrel", sprite: "BAR1", sequence: "ab+" },
};
